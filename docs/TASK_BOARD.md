...
| Tarea | Equipo | Prioridad | Round | Depende de | Nota |
| --- | --- | --- | --- | --- | --- |
| `TASK-111` - Decidir entrada a multiempresa controlado | Product / Architect / Release | P1 | Round 5 | `TASK-110` | Configuracion de empresa aprobada; decidir siguiente fase. |
